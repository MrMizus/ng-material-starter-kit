...
import {
  CategoriesLoadingCheckComponent
} from './components/categories-loading-check/categories-loading-check.component';
...
import {
  FilteredProductsRoutingComponent
} from './components/filtered-products-routing/filtered-products-routing.component';
...
} from './components/filtered-products-list/filtered-products-list.component-module';
...
} from './components/employee-refresh-list/employee-refresh-list.component-module';
...
import {
  CategoriesLoadingCheckComponentModule
} from './components/categories-loading-check/categories-loading-check.component-module';
...
import {
  FilteredProductsRoutingComponentModule
} from './components/filtered-products-routing/filtered-products-routing.component-module';
...
import {ProductCartServiceModule} from './services/product-cart.service-module';


@NgModule({
  imports: [RouterModule.forRoot([{
    path: 'products-subject',
    component: FilteredProductsListComponent
